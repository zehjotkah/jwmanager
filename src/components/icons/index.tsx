...
// Generische Icon-Komponente für bessere Konsistenz
...
export function Diamond({ size = 24, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <polygon points="2.44 12 12 21.56 21.56 12 12 2.44 2.44 12" />
    </svg>
  )
}

export function Wheat({ size = 24, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function BookOpenCheck({ size = 24, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function Edit2({ size = 24, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function Radio({ size = 24, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
